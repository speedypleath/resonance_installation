...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 581.0, 576.0, 159.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 573.0, 454.0, 300.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 74.0, 354.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 74.0, 190.0, 292.0, 105.0 ],
					"varname" : "randomiser",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 581.0, 632.0, 45.0, 45.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal", "signal", "", "list", "int", "", "", "" ],
									"patching_rect" : [ 216.0, 590.0, 300.0, 100.0 ],
									"save" : [ "#N", "vst~", "loaduniqueid", 0, "C74_AU:/kHs Compressor", ";" ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
											"parameter_invisible" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 361.0, 496.0, 29.5, 22.0 ],
									"text" : "+~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 618.0, 533.0, 102.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 418.0, 69.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "preset", "int", "preset", "int", "" ],
									"patching_rect" : [ 793.0, 353.0, 100.0, 40.0 ],
									"preset_data" : [ 										{
											"number" : 1,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 518.0, 448.0, 22.0, 140.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 567.0, 362.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 518.0, 404.0, 68.0, 22.0 ],
									"text" : "cverb~ 100"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 834.0, 169.0, 135.0, 22.0 ],
									"saved_object_attributes" : 									{
										"client_rect" : [ 100, 100, 500, 600 ],
										"parameter_enable" : 0,
										"parameter_mappable" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 871.0, 242.0, 56.0, 22.0 ],
									"restore" : 									{
										"vst~" : [ 											{
												"filetype" : "C74Snapshot",
												"version" : 2,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 383.0, 332.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 248.0, 396.0, 65.0, 22.0 ],
									"text" : "overdrive~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 223.0, 759.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 246.0, 70.0, 36.0, 22.0 ],
									"text" : "r kick"
								}
...
,
									"patching_rect" : [ 246.0, 165.0, 420.0, 150.0 ],
									"varname" : "custom.drum",
									"viewvisibility" : 1
								}
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						...
						"live.gain~[1]" : [ -0.27777777777778 ],
						"live.gain~[2]" : [ -8.659793814432991 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 562.75, 453.0, 863.5, 453.0 ],
					"source" : [ "obj-10", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 555.5, 453.0, 582.5, 453.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 1 ],
					"midpoints" : [ 624.75, 453.0, 567.0, 453.0, 567.0, 633.0, 616.5, 633.0 ],
					"source" : [ "obj-12", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"midpoints" : [ 617.5, 453.0, 567.0, 453.0, 567.0, 633.0, 590.5, 633.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-53", 1 ],
					"midpoints" : [ 685.75, 453.0, 863.5, 453.0 ],
					"source" : [ "obj-13", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-53", 0 ],
					"midpoints" : [ 678.5, 453.0, 582.5, 453.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-53", 1 ],
					"midpoints" : [ 747.75, 453.0, 863.5, 453.0 ],
					"source" : [ "obj-14", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-53", 0 ],
					"midpoints" : [ 740.5, 453.0, 582.5, 453.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 622.64285714285711, 567.0, 730.5, 567.0 ],
					"source" : [ "obj-53", 1 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-54" : [ "live.gain~[5]", "live.gain~[5]", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
...
, 			{
				...
				"patcherrelativepath" : "../../../Packages/Rhythm and Time Toolkit/media/icons",
				"type" : "svg",
				"implicit" : 1
			}
, 			{
				...
				"patcherrelativepath" : "../../../Packages/Custom Patches/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"patcherrelativepath" : "../../../Packages/Rhythm and Time Toolkit/patchers/modules/clock",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"patcherrelativepath" : "../../../Packages/Rhythm and Time Toolkit/patchers/modules/dist",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"patcherrelativepath" : "../../../Packages/Rhythm and Time Toolkit/patchers/module-components",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				...
				"patcherrelativepath" : "../../../Packages/Rhythm and Time Toolkit/javascript",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
